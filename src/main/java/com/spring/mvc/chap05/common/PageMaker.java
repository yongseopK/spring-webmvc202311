...
public class PageMaker {
    ...
    private void makePageInfo() {
        ...
        // 3. prev 활성화 여부
        /*
                1 ~ 10 구간에는 prev가 안보여도 됨
                11 ~ 20 구간에는 1 ~ 10구간으로 이동가능하므로 prev를 활성화
         */
        this.prev = begin > 1;
        ...
        /*
            ...
            1 ~ 10 페이지 구간 : 게시물 총 100개
            11 ~ 20 페이지 구간 : 게시물 총 100개
            21 ~ 30 페이지 구간 : 게시물 총 37개 => 끝 페이지가 30이 맞는가? 24페이지여야함
            => 30을 24로 보정해야함
